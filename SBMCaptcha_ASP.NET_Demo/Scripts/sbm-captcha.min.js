    ...
    a.fn.extend({
        sbmCaptcha: function (b) {
            ...
            return this.each(function (f) {
                ...
                function j() {
                    d.captchaFontFamily ? r.css('font-family', d.captchaFontFamily) : a('body').append('<!-- SBM Captcha default font --><link href="https://fonts.googleapis.com/css?family=Roboto:400,500" rel="stylesheet">');
                    ...
                    if ('show' === d.showCredits || 'hide' === d.showCredits) {
                        ...
                        x.push('<div class=\'' + y + '\' title=\'SBMCaptcha by PT SHIMANO BATAM\'>', '<a href=\'#\' target=\'_blank\' rel=\'follow\'>SBMCaptcha</a> &copy;', '</div>')
                    }
